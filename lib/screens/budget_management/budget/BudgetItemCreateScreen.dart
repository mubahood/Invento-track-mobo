...
class _BudgetItemCreateScreenState extends State<BudgetItemCreateScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("${isEdit ? 'Updating' : 'Creating new'} Budget item"),
      ),
      body: SafeArea(
              ...
              children: [
                ...
                FormBuilderTextField(
                  ...
                  onChanged: (String? val) {
                    ...
                    try {
                      widget.item.target_amount =
                          (Utils.int_parse(widget.item.unit_price) *
                                  Utils.int_parse(widget.item.quantity))
                              .toString();
                    } catch (e) {}
                    setState(() {});
                  },
