  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        floatingActionButton: FloatingActionButton(
          onPressed: () async {
            BudgetItemModel i = BudgetItemModel();
            i.budget_program_id = category.budget_program_id;
            i.budget_program_text = category.budget_program_text;
            i.budget_item_category_id = category.id.toString();
            i.budget_item_category_text = category.name;
            await Get.to(() => BudgetItemCreateScreen(i));
            myInit();
          },
        ...
        body: items.isEmpty
            ? emptyListWidget("No Item Found", "Refresh", () {
                myInit();
              })
            : RefreshIndicator(
                onRefresh: () async {
